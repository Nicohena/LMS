...
export function CatalogView({ onSelectCourse, onNavigate }: { onSelectCourse: (id: string) => void; onNavigate: (v: View) => void }) {
...
export function MyCoursesView({ onSelectCourse, onNavigate }: { onSelectCourse: (id: string) => void; onNavigate: (v: View) => void }) {
  const user = useAuthStore((s) => s.user);
  const role = (user?.role ?? 'STUDENT') as Role;
  const [searchQuery, setSearchQuery] = useState('');
...
export function PageContentEditor({ courseId, contentId, canAuthor }: { courseId: string; contentId: string; canAuthor: boolean }) {
...
export function CourseDetailView({ courseId, onNavigate, onSelectQuiz, onSelectAssignment }: { courseId: string; onNavigate: (v: View) => void; onSelectQuiz?: (id: string) => void; onSelectAssignment?: (id: string) => void }) {
